...
/**
 * REST controller exposing CRUD operations for faculties. Creating, updating and deleting
 * faculties are restricted to administrators. Listing and retrieving faculties can be
